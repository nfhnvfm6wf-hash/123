(() => {
  ...
  /* ---------------------------------------------------------------------
     Real photo slots (.js-photo): пока файл (например assets/img/hero.jpg)
     не добавлен, показывается декоративная SVG-заглушка позади него.
     Достаточно положить фото с нужным именем в assets/img/ — код менять не нужно.
  --------------------------------------------------------------------- */
  document.addEventListener('error', (e) => {
    if (e.target.classList && e.target.classList.contains('js-photo')) {
